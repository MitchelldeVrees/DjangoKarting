...
from competition.views import competition_detail_view, create_competition, delete_competition, update_competition
...
urlpatterns = [
    ...
    path('competition/', competition_detail_view),
    path('addcompetition/', create_competition),
